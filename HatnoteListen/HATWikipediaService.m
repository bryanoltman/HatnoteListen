...
- (void)receiveMessageForWebSocketTask:(NSURLSessionWebSocketTask*)task
                              language:(HATWikipediaLanguage*)language {
...
#ifdef DEBUG
  NSLog(@"Closed socket task %@ with reason: %@", webSocketTask,
